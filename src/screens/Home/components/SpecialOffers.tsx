...
export default function SpecialOffers() {
  ...
  return (
    <div className='px-5' onClick={transitions(() => navigate('/special_offer'))}>
      <div className='tap99 mx-auto flex max-w-sm gap-2 rounded-3xl border border-[#77777722] bg-inputBg/50 p-2.5 shadow-[0_0_4px_0_rgba(0,0,0,0.0)] dark:bg-white/10 dark:shadow-[0_0_10px_0_rgba(255,255,255,0.1)]'>
