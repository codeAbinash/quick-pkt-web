...
export default function PopupAlert() {
  ...
  return (
    <div className='fixed z-[100] flex h-screen w-full select-none items-center justify-center'>
      <div className='w-[85%] max-w-sm rounded-3xl border border-black/10 bg-white/90 shadow-[0px_0px_100vh_100dvh_#00000015,0_0_10px_10px_#00000005] backdrop-blur-lg dark:border-white/10  dark:bg-black/90'>
